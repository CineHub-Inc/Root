...
import { initPowerUserCountdown } from '../power-user/countdown-component.js';
        ...
        <div class="command-bar" id="command-bar">
            ...
            <div class="profile-widget" id="command-bar-profile-widget">
                ...
                <div class="profile-dropdown" role="menu">
                    <div class="profile-dropdown-greeting" id="profile-greeting">Hello</div>
                    
                    <!-- Power User Countdown Container -->
                    <div id="power-user-countdown-container"></div>
                    
                    <button id="profile-settings-btn" class="profile-dropdown-item" role="menuitem">
    ...
    if (profileWidget && profileToggle) {
        ...
        if (dropdown) {
            dropdown.addEventListener('click', (e) => {
                ...
                const profileBtn = e.target.closest('#profile-settings-btn');
...
function init() {
    ...
    initSearchLogic();
    initHistoryTrail();
    initPowerUserCountdown('power-user-countdown-container');
    ...
    document.addEventListener('user-data-updated', () => {
        ...
        // Update greeting
        if (greetingEl) {
            greetingEl.textContent = userData.name ? `Welcome, ${userData.name}!` : `Welcome, ${userData.email}!`;
        }
